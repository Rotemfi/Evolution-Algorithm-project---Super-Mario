...
<body dir="rtl">
  ...
  <h3> הקדמה - סופר מריו </h3>
      <p>סופר מריו הוא דמות מצוירת ממשחק וידאו פופולרי של חברת "נינטנדו" היפנית. מריו הוא שרברב איטלקי הנמצא בממלכת פטריות מלאה הרפתקאות. אין לו כלי נשק בניגוד למשחקי וידאו רבים אחרים: הוא משתמש בקפיצה והתחמקות על מנת להתמודד עם אויבי הנקרים בדרכו.
    </p>
    <p>
...
<img src="https://github.com/Rotemfi/Evolution-Algorithm-project---Super-Mario/blob/main/images/9Mqk69QEqokuwXL.png" align="center" width="500" height="100">
 ...
 <h2>ניסויים, מהלך האבולוציה ותוצאות</h2>
    <p>
   תחילה ניסינו להבין אילו פרמטרים של גודל אוכלוסיה ומספר דורות אנו צריכים לבחור בכדי לקבל תוצאה אופטימלית עבור האלגוריתם. התחלנו את הניסויים מגודל אוכלוסיה של 100  והרצנו את האלגוריתם 100,500,1000 דורות. <br/>
<br/>
     <b>קיבלנו את הגרפים הבאים:</b>
  </p>
    <p>
     <u> עבור מספר דורות של 100 קיבלנו:</u>
  </p>
   <p>
  
   ![100generation]( https://github.com/Rotemfi/Evolution-Algorithm-project---Super-Mario/blob/main/images/pop_100_gen_100.png)
  </p>
    <p>
     <u> עבור מספר דורות של 500 קיבלנו:</u>
  </p>
   <p>
  
   ![500generation]( https://github.com/Rotemfi/Evolution-Algorithm-project---Super-Mario/blob/main/images/pop_100_gen_500.png)
  </p>
    <p>
     <u> עבור מספר דורות של 1000 קיבלנו:</u>
  </p>
   <p>
  
   ![1000generation]( https://github.com/Rotemfi/Evolution-Algorithm-project---Super-Mario/blob/main/images/pop_100_gen_1000.png)
  </p>
  <br/>
  <p>
  קיבלנו כי עבור גודל אוכלוסיה קטן יחסית מקבלים תוצאות שאינן מתכנסות לbest fitness.
לכן החלטנו לבדוק גדלים שונים של אוכלוסיה.
  </p>
   <p>
...
את כל הניסויים ביצענו על שלב מספר 8.<br/>
<br/>
...
<img src="https://github.com/Rotemfi/Evolution-Algorithm-project---Super-Mario/blob/main/images/9Mqk69QEqokuwXL.png" align="center" width="500" height="100">
 ...
 <h2>מסקנות</h2>
   <h3>גודל אוכלוסייה קטן לא מתכנס</h3>
   <p>
 עבור גודל אוכלוסיה של 100 פרטים הרצנו את האלגוריתם מספר רב של פעמים עם מספר דורות משתנה  בין 100-1000 וקיבלנו כי אין התכנסות לbest fitness בשום ריצה של האלגוריתם. הצלחנו להסיק מכך כי מספר קטן של דורות מצמצם מאד את נקודת הפתיחה של האלגוריתם, האלגוריתם מתחיל מוקטורים רנדומליים ומשדרג אותם בכל דור ודור אך אם המספר ההתחלתי שלהם קטן אז ישנם המון מסלולים שאנחנו מפספסים ולא בודקים אפילו כאשר אנו מריצים המון דורות. לכן כמסקנה החלטנו להגדיל את גודל האוכלוסיה ולבצע את הניסויים מחדש עם אוכלוסיה גדולה יותר.
   </p><br/>
